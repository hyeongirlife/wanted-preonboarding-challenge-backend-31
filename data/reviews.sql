-- 리뷰(Review) 데이터 삽입
INSERT INTO "Review" (id, "productId", "userId", rating, title, content, "createdAt", "updatedAt", "verifiedPurchase", "helpfulVotes") VALUES
-- 김지원의 리뷰
...
(60, 28, 6, 4, '실용적인 캠핑 테이블', '가볍고 설치도 간단해서 캠핑이나 피크닉에 자주 사용하고 있어요. 생각보다 튼튼해서 여러 용도로 활용하고 있습니다. 높이 조절이 안 되는 점만 아쉬워요.', '2025-04-17 14:15:00', '2025-04-17 14:15:00', true, 14),
...
(86, 28, 9, 4, '실용적인 캠핑 테이블', '가볍고 설치도 간단해서 캠핑이나 피크닉에 자주 사용하고 있어요. 생각보다 튼튼해서 여러 용도로 활용하고 있습니다. 높이 조절이 안 되는 점만 아쉬워요.', '2025-04-05 15:20:00', '2025-04-05 15:20:00', true, 14),
...
(99, 21, 10, 4, '가벼운 등산 텐트', '생각보다 가볍고 설치도 간편해서 좋아요. 방수 기능도 뛰어나서 비가 와도 안심하고 사용할 수 있어요. 환기가 조금 아쉬운 점만 빼면 좋은 제품입니다.', '2025-04-16 10:15:00', '2025-04-16 10:15:00', true, 19),
...
-- 시퀀스 재설정
SELECT pg_catalog.setval('"Review_id_seq"', (SELECT MAX(id) FROM "Review"), true);
